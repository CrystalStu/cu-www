...
<link href="css/mainhtml.css" rel="stylesheet" />
</head>
...
<body>
  ...
  <div class="container-fluid mt-3">
    <div class="row">
      <div class="col-md-12">
        <h1 class="text-center">Crystal Studios</h1>
      </div>
    </div>
    <hr>
  </div>
  <div class="container">
    <div class="row text-center">
      <div class="col-md-12">Crystal Studios is a united organization which help people live, entertain,
        and research. <br><strong>Feel free to use our services :-)</strong></div>
    </div>
    <hr>
    <div class="row">
      <div class="text-center col-md-12">
        <div class="well"><strong> Sub organizations</strong></div>
      </div>
      <div class="col-sm-12">
    ...
    <div class="row">
      <div class="text-center col-md-12">
        <div class="well"><strong> Applications</strong></div>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-12">
    ...
    <div class="row">
      <div class="text-center col-md-12">
        <div class="well"> Partner Links</div>
      </div>
      <div class="col-sm-12">
        <ul class="list-group list-group-flush">
          <li class="list-group-item"><a href="https://www.boulkoo.com/" target="_blank"><img src="https://www.boulkoo.com/favicon.ico" />&nbsp;BOULKOO</a></li>
        </ul>
      </div>
    </div>
